      ...
      <div>
        ...
        <div className="resultContainer">
          <div className="resultInfo">
            ...
            <ul className="info">
              <li style={{ display: ldapData.objectClass ? 'inline' : 'none' }} className={ldapData.objectClass === testData.objectClass ? 'toRed' : ''}><span>用户对象类：</span><span>{ldapData.objectClass}</span></li>
              ...
              <li style={{ display: ldapData.realNameField ? 'inline' : 'none' }} className={ldapData.realNameField === testData.realNameField ? 'toRed' : ''}><span>用户名属性：</span><span>{ldapData.realNameField}</span></li>
              <li style={{ display: ldapData.passwordField ? 'inline' : 'none' }} className={ldapData.passwordField === testData.passwordField ? 'toRed' : ''}><span>密码属性：</span><span>{ldapData.passwordField}</span></li>
              <li style={{ display: ldapData.phoneField ? 'inline' : 'none' }} className={ldapData.phoneField === testData.phoneField ? 'toRed' : ''}><span>手机号属性：</span><span>{ldapData.phoneField}</span></li>
