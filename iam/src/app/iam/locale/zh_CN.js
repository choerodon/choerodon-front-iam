...
// status
// success
  "iam.operation.success": "操作成功",
  "iam.create.success": "创建成功",
  "iam.modify.success": "修改成功",
  "iam.delete.success": "删除成功",
  "iam.remove.success": "移除成功",
  "iam.enable.success": "启用成功",
  "iam.disable.success": "停用成功",
// error
  "iam.operation.error": "操作失败",
  "iam.create.error": "创建失败",
  "iam.modify.error": "修改失败",
  "iam.delete.error": "删除失败",
  "iam.remove.error": "移除失败",
  "iam.enabled.error": "启用失败",
  "iam.disable.error": "停用失败",

  //组织管理
  "global.organization.headertitle": "组织管理",
  ...
  "global.organization.modify": "修改",
  "global.organization.enable": "启用",
  "global.organization.disable": "停用",
  "global.organization.modify": "修改组织",
  "global.organization.modifytitle": "对组织\"{name}\"进行修改",
  "global.organization.modifydescription": "您可以在此修改组织名称",
  "global.organization.createtitle": "在平台\"{name}\"中创建组织",
  "global.organization.createdescription": "请在下面输入组织编码、组织名称创建组织。组织编码在全平台是唯一的，组织创建后，不能修改组织编码。",
  ...
  //  菜单配置
  "global.menusetting.headertitle": "菜单配置",
  ...
  "global.menusetting.link": "http://choerodon.io/zh/docs/user-guide/system-configuration/platform/menu_configuration/",
  ...
  "global.menusetting.modify": "修改",
  "global.menusetting.delete": "删除",
  "global.menusetting.detial": "详情",
  "global.menusetting.createorg": "创建目录",
  "global.menusetting.createtitle": "在平台\"{name}\"中创建目录",
  "global.menusetting.createdescription": "请在下面输入目录名称、编码，选择目录图标创建目录。您创建的目录为自设目录，自设目录可以修改、删除。而平台内置的目录为预置目录，您不能创建、修改、删除预置目录。",
  "global.menusetting.createlink": "http://choerodon.io/zh/docs/user-guide/system-configuration/platform/menu_configuration/",
  "global.menusetting.directoryname": "目录名称",
  "global.menusetting.directorycode": "目录编码",
  "global.menusetting.chooseicon": "请选择一个图标",
  "global.menusetting.namerequiredmsg":"请输入目录名称",
  "global.menusetting.coderequiredmsg": "请输入目录编码",
  "global.menusetting.codepattern": '编码只能由小写字母、数字、"-"组成，且以小写字母开头，不能以"-"结尾',
  "global.menusetting.modifyorg": "修改目录",
  "global.menusetting.modifytitle": "对目录\"{name}\"进行修改",
  "global.menusetting.modifydescription": "您可以在此修改目录名称、图标。",
  "global.menusetting.deletesuccess": "删除成功，请点击保存",
  "global.menusetting.deleteowntitle": "删除自设目录",
  "global.menusetting.deleteowncontent": "确认删除自设目录\"{name}\"吗?",
  "global.menusetting.createorgsuccess": "创建目录成功，请点击保存",
  "global.menusetting.modifyorgsuccess": "修改目录成功，请点击保存",
  "global.menusetting.viewdetail": "查看详情",
  "global.menusetting.detailtitle": "查看菜单\"{name}\"详情",
  "global.menusetting.detaildescription": "您可以在此查看菜单的名称、编码、层级、所属预置目录、权限。菜单是平台内置的，您不能创建、修改、删除菜单。",
